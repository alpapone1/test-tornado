...
variable "aws_key" {
  ...
  default     = "prod-tornado"
}

variable "dns_name" {
  description = "DNS Name"
  type        = string
  default     = "prod-paolo.tornado.com"
}
...
variable "instance_name" {
  ...
  type        = string
  default     = "prod-tornado-webserver"
}

variable "endpoint" {
  description = "Value of the endpoint"
  type        = string
  default     = "http://rds-prod.tornado.com"
}
...
variable "subnet_name_private" {
  default = "db-prod-prod-tornado-private"
}
